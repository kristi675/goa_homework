...
Use the format() function to replace {name} with "Alice" and {place} with "Wonderland". 
Store the result in a variable named formatted_string and print it.
...
Use the split() function to split the sentence into a list of words.
 Store the result in a variable named words_list and print it.
'''
...
Use the replace() function to replace the word "be" with "code".
 Store the result in a variable named modified_quote and print it.
'''

# quote = "To be or not to be, that is the question."
# modifited_quote = quote.replace("be","code") 
# print(modifited_quote)

'''
Task 6: Converting to Lowercase
Create a string named mixed_case with the following content: "PyThOn Is AwEsOmE!"
Use the lower() function to convert the entire string to lowercase.
 Store the result in a variable named lowercase_string and print it.
'''
...
Use the upper() function to convert the entire string to uppercase.
 Store the result in a variable named uppercase_greeting and print it.
'''
